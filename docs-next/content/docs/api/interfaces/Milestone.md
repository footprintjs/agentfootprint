...
Defined in: [src/conventions.ts:269](https://github.com/footprintjs/agentfootprint/blob/main/src/conventions.ts#L269)
...
Defined in: [src/conventions.ts:272](https://github.com/footprintjs/agentfootprint/blob/main/src/conventions.ts#L272)

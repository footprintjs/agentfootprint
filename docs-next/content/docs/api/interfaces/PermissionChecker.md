...
Defined in: src/adapters/types.ts:815
...
Defined in: src/adapters/types.ts:848
...
- a [ToolCapability](/docs/api/type-aliases/ToolCapability) — asked once per declared capability, per
...
Defined in: src/adapters/types.ts:816
...
Defined in: src/adapters/types.ts:817

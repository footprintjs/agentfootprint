...
Defined in: [src/core/agent/window/types.ts:273](https://github.com/footprintjs/agentfootprint/blob/main/src/core/agent/window/types.ts#L273)
...
Defined in: [src/core/agent/window/types.ts:284](https://github.com/footprintjs/agentfootprint/blob/main/src/core/agent/window/types.ts#L284)

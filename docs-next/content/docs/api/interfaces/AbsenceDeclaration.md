...
Defined in: [src/core/agent/coverage/types.ts:67](https://github.com/footprintjs/agentfootprint/blob/main/src/core/agent/coverage/types.ts#L67)
...
Defined in: [src/core/agent/coverage/types.ts:80](https://github.com/footprintjs/agentfootprint/blob/main/src/core/agent/coverage/types.ts#L80)
...
Defined in: [src/core/agent/coverage/types.ts:73](https://github.com/footprintjs/agentfootprint/blob/main/src/core/agent/coverage/types.ts#L73)

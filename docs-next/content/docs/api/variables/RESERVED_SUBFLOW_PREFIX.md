...
Defined in: [src/conventions.ts:96](https://github.com/footprintjs/agentfootprint/blob/main/src/conventions.ts#L96)
...
tells LIBRARY PLUMBING from CONSUMER STRUCTURE by this prefix and nothing
  ...
  • [stageRole](/docs/api/functions/stageRole) and the pattern/fingerprint readers classify by the
    same convention.

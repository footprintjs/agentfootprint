...
> `const` **ABSENCE\_NOTE**: `string`

Defined in: [src/core/agent/coverage/absent.ts:61](https://github.com/footprintjs/agentfootprint/blob/main/src/core/agent/coverage/absent.ts#L61)

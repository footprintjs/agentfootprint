---
title: PRESENT_TOOL_NAME
---

# Variable: PRESENT\_TOOL\_NAME

> `const` **PRESENT\_TOOL\_NAME**: `"present"` = `'present'`

Defined in: [src/artifacts/present.ts:36](https://github.com/footprintjs/agentfootprint/blob/main/src/artifacts/present.ts#L36)

...
Defined in: [src/core/agent/coverage/recognize.ts:18](https://github.com/footprintjs/agentfootprint/blob/main/src/core/agent/coverage/recognize.ts#L18)

...
[`SurfaceMode`](/docs/api/type-aliases/SurfaceMode) \| `undefined`
...
[`Injection`](/docs/api/interfaces/Injection) \| `undefined`
...
`string` \| [`Injection`](/docs/api/interfaces/Injection)

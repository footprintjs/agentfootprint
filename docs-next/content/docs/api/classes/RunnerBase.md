...
Defined in: [src/core/RunnerBase.ts:66](https://github.com/footprintjs/agentfootprint/blob/main/src/core/RunnerBase.ts#L66)
...
Defined in: [src/core/RunnerBase.ts:315](https://github.com/footprintjs/agentfootprint/blob/main/src/core/RunnerBase.ts#L315)
...
[`Runner`](/docs/api/interfaces/Runner).[`shutdown`](/docs/api/interfaces/Runner#shutdown)

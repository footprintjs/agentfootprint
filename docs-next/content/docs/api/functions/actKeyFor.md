...
Defined in: [src/core/agent/moments.ts:61](https://github.com/footprintjs/agentfootprint/blob/main/src/core/agent/moments.ts#L61)

The runtime twin of [ActKey](/docs/api/type-aliases/ActKey). `.act()`'s accepted key set is built

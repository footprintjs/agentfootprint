...
Defined in: [src/lib/injection-engine/skillContract.ts:41](https://github.com/footprintjs/agentfootprint/blob/main/src/lib/injection-engine/skillContract.ts#L41)

...
Defined in: [src/lib/rag/indexDocuments.ts:188](https://github.com/footprintjs/agentfootprint/blob/main/src/lib/rag/indexDocuments.ts#L188)
...
readonly [`RagDocument`](/docs/api/type-aliases/RagDocument)[]

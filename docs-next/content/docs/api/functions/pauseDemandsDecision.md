...
Defined in: [src/core/pause.ts:154](https://github.com/footprintjs/agentfootprint/blob/main/src/core/pause.ts#L154)
...
[`ConsentGate`](/docs/api/interfaces/ConsentGate) \| `undefined`

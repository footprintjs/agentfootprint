...
primitives, **[Microsoft Foundry](doc:microsoft-foundry)** is the same map for a
...
self-hosted](doc:on-premises)** is the same map for a deployment that owns its
...
- **[Microsoft Foundry](doc:microsoft-foundry)** — the youngest column, mapped the same way.

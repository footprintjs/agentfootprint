...
**control plane** — listing deployments, creating resources. A third constant,
**`AZURE_COGNITIVE_SERVICES_SCOPE`**
(`https://cognitiveservices.azure.com/.default`), names the classic Azure OpenAI
data-plane audience — `azureOpenai({ credential })` defaults to it because that
is the audience the deployment-scoped route documents.

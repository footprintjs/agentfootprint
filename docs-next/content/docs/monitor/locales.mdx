...
## What ships in `agentfootprint/observe`
...
- [Observability guide](doc:observability) — what the catalogs drive
- [Streaming guide](doc:streaming) — `streamRecorder` consumes these too

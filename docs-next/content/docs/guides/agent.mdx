...
65 typed events fire across 18 domains during a single `agent.run()`. See the [Observability guide](/agentfootprint/guides/observability/) for the full taxonomy.

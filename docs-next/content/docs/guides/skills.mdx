...
This is a [Dynamic ReAct](/agentfootprint/guides/dynamic-react/) payoff: the next iteration's tool list reshapes based on what just happened. 3× context-budget reduction in large catalogs + sharper LLM tool-choice.

...
84 typed events across 20 domains. Your IDE auto-completes payload shapes per event name. See [Observability guide](doc:observability) for the full taxonomy.

...
94 typed events across 21 domains. Your IDE auto-completes payload shapes per event name. See [Observability guide](doc:observability) for the full taxonomy.

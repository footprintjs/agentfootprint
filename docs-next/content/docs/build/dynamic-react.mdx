...
Edit the question and hit **Run** — the **real agent runs right here in your browser** (with a mock LLM, no network, no server) and traces live, iteration by iteration. The mock reads the city out of your question, so the trace responds to what you ask.

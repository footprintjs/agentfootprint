...
- **Frontend render-by-ref (the component registry that validates `as`), typed HITL payloads, S3/GCS adapters, streaming, and staging refs INTO code sessions are later phases** — this page is the store and the data legs.

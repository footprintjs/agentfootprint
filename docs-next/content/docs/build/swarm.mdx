...
If you need LLM-driven routing, use [Conditional](doc:key-concepts#3-conditional--branch-on-a-decider) with an LLM-based predicate — different shape, same outcome.

...
1. **Source injection** — the source material (docs, policy text, retrieved chunks, prior decisions) lands in the messages slot via [RAG](doc:rag), [Memory](doc:memory), or `defineFact`. The LLM sees it as fresh context.

 ...
 * `data` is the server's projection of that demo's real compiled graph. Graph
 * builders and tool execution code are never imported by this client boundary.
 */
export function SkillGraphTryItClient({
  children,
  data,
}: {
  children?: ReactNode;
...
export default SkillGraphTryItClient;

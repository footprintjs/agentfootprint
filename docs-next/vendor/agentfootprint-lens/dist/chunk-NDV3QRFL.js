...
import { walkSubflowSpec as walkSubflowSpec2 } from "footprintjs/trace";
...
function structureGraphFromRunner(runner) {
  ...
  const spec = runner.getSpec().buildTimeStructure;
  for (const item of walkSubflowSpec2(spec, "", { recurse: false, convergenceEdges: true })) {
    switch (item.kind) {
      case "stage":
        recorder.onStageAdded?.({
          stageId: item.stageId,
...
//# sourceMappingURL=chunk-NDV3QRFL.js.map
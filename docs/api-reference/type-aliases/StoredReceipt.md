...
[agentfootprint](/agentfootprint/api/generated/README.md) / StoredReceipt
...
[Receipt](/agentfootprint/api/generated/interfaces/Receipt.md) is what a MINT writes, and a mint writes every container it
...
> `readonly` `optional` **cache?**: `Omit`\<[`Receipt`](/agentfootprint/api/generated/interfaces/Receipt.md)\[`"cache"`\], `"strategy"`\> & `object`

#### Type Declaration

##### strategy?

> `readonly` `optional` **strategy?**: [`Receipt`](/agentfootprint/api/generated/interfaces/Receipt.md)\[`"cache"`\]\[`"strategy"`\]

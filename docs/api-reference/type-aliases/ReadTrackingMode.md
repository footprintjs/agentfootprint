...
[agentfootprint](/agentfootprint/api/generated/README.md) / ReadTrackingMode
...
- `'summary'` — reads record a cheap [ReadSummaryMarker](/agentfootprint/api/generated/interfaces/ReadSummaryMarker.md) (type + size

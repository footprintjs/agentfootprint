...
[agentfootprint](/agentfootprint/api/generated/README.md) / ContextSlot

# Type Alias: ContextSlot

> **ContextSlot** = `"system-prompt"` \| `"messages"` \| `"tools"`

Defined in: [src/events/types.ts:9](https://github.com/footprintjs/agentfootprint/blob/d1cb45510740421f2b84b6de9f852a72e94bb106/src/events/types.ts#L9)

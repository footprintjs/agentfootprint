...
[agentfootprint](/agentfootprint/api/generated/README.md) / RunbookEnvelope
...
> `readonly` `optional` **verdicts?**: readonly [`VerdictRow`](/agentfootprint/api/generated/interfaces/VerdictRow.md)[]

#### walk

> `readonly` **walk**: [`WalkDescriptor`](/agentfootprint/api/generated/interfaces/WalkDescriptor.md)

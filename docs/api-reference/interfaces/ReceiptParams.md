...
[agentfootprint](/agentfootprint/api/generated/README.md) / ReceiptParams
...
PORT VALUES ONLY — see [RECEIPT\_BOUNDARY](/agentfootprint/api/generated/variables/RECEIPT_BOUNDARY.md). An unset `maxTokens` may

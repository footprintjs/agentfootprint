...
[agentfootprint](/agentfootprint/api/generated/README.md) / LIBRARY\_AUTHORED\_PREFIXES

# Variable: LIBRARY\_AUTHORED\_PREFIXES

> `const` **LIBRARY\_AUTHORED\_PREFIXES**: readonly `string`[]

Defined in: [src/lib/saidByPerson.ts:122](https://github.com/footprintjs/agentfootprint/blob/f5cabfd85eeae981c1a9a9dd20edaa7a4ced5063/src/lib/saidByPerson.ts#L122)

...
[agentfootprint](/agentfootprint/api/generated/README.md) / toolDigestInput

# Function: toolDigestInput()

> **toolDigestInput**(`tool`): `string`

Defined in: [src/lib/time-travel/receipt.ts:552](https://github.com/footprintjs/agentfootprint/blob/8eb817f55f177662ed213c7b387a5bdc2527c87b/src/lib/time-travel/receipt.ts#L552)

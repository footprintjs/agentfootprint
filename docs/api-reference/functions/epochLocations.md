...
[agentfootprint](/agentfootprint/api/generated/README.md) / epochLocations

# Function: epochLocations()

> **epochLocations**(`source`): readonly [`EpochLocation`](/agentfootprint/api/generated/interfaces/EpochLocation.md)[]

Defined in: [src/lib/time-travel/epochs.ts:217](https://github.com/footprintjs/agentfootprint/blob/8eb817f55f177662ed213c7b387a5bdc2527c87b/src/lib/time-travel/epochs.ts#L217)
...
asked for is not here", which is what [epochAt](/agentfootprint/api/generated/functions/epochAt.md) says with `undefined`.
...
readonly [`EpochLocation`](/agentfootprint/api/generated/interfaces/EpochLocation.md)[]

...
65 typed events across 18 domains. Your IDE auto-completes payload shapes per event name. See [Observability guide](/agentfootprint/guides/observability/) for the full taxonomy.

...
- The 5-layer taxonomy: 2 primitives (LLM, Agent), 3 compositions (Sequence, Parallel, Conditional), named patterns (Reflexion, Tree-of-Thoughts, Hierarchy/Swarm, Plan-Execute, Map-Reduce, Dynamic ReAct), context engineering (RAG, Memory, Skills, Instructions, Grounding), and infrastructure features

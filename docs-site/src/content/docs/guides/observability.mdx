...
|---|---|---|
| `agent` | `turn_start` · `turn_end` · `iteration_start` · `iteration_end` · `route_decided` · `handoff` | ReAct loop boundaries |
...
| `tools` | `offered` · `activated` · `deactivated` | ToolProvider activation per iteration (skills, gating) |
...
| `permission` | `check` · `gate_opened` · `gate_closed` | PermissionChecker decisions |

# Changelog — 8.x and earlier

Archived from the root [CHANGELOG.md](../CHANGELOG.md), which keeps the current major (9.x) onward.
The format is [Keep a Changelog](https://keepachangelog.com/en/1.1.0/); versions follow [SemVer](https://semver.org/spec/v2.0.0.html).

...
export {
  ...
  bindArtifacts,
  // Recordings-as-artifacts (9.26.0) — a completed run's
  // `{ snapshot, events, structure }` checked in under kind 'recording/run',
  // so the existing artifact wire ops serve the Lens with no new operation.
